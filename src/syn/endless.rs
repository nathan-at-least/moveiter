...
use crate::adapters::{EmiAsAsync, EmiAsFinite, EmiAsIterator, EmiAsTerminal};
...
pub trait EndlessMoveIterator: Sized {
    ...
    /// Convert into a [std::iter::Iterator].
    fn into_iter(self) -> EmiAsIterator<Self> {
        EmiAsIterator::new(self)
    }
